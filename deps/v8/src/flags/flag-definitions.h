...
DEFINE_BOOL(heap_snapshot_dump_strings_storage, false,
            "dump the heap snapshot strings storage")
DEFINE_BOOL(profile_heap_snapshot, false,
            "dump time spent on heap snapshot")
